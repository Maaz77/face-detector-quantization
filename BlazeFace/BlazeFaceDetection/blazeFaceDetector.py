...
class blazeFaceDetector():
	...
	def initializeModel(self, type):
		if type == "front":
			...
			self.interpreter = tf.lite.Interpreter(model_path="models/face_detection_back_256x256_integer_quant.tflite")
	...
	def updateFps(self):
		...
		if self.frameCounter == updateRate:
			...
			self.fps = int(updateRate/(ellapsedTime+0.001))
			self.frameCounter = 0
