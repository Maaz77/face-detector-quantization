...
def main():
    ...
    model_path = "CenterFace/Models/centerface_1x3xHxW_integer_quant.tflite" #this the qunatized first version model using the webcame calib data that works well
